function [path_dir_learn, crossdir_learn,...
...
%assign to new variable for learning cohort
path_dir_learn = path_dir;
crossdir_learn = crossdir;

%clear variables
clear path_dir crossdir;
...
% %cross session directory
crossdir{1} = 'G:\OCGOL_stability_recall\I47_LP\crossSession_update';
% 
...
% %cross session directory
crossdir{2} = 'G:\OCGOL_stability_recall\I42R_1\crossSession_update';
...
% %cross session directory
crossdir{3} = 'G:\OCGOL_stability_recall\I46\crossSession_update';
...
% %cross session directory
crossdir{4} = 'G:\OCGOL_stability_recall\I45_RT\crossSession_update';
...
%cross session directory
crossdir{5} = 'G:\OCGOL_stability_recall\I42L_1\crossSession_update';

path_dir_st_recall = path_dir;
crossdir_st_recall = crossdir;

clear path_dir crossdir;

%% Long term recall directories
...
path_dir_lt_recall = path_dir;
crossdir_lt_recall = crossdir;

clear path_dir crossdir;

%% Directories for Figure 2/3 task-selective and remapping neurons
