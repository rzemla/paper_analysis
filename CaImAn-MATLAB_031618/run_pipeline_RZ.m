...
foldername = 'E:\I42L_AB_d1_032118_1';
...
[Am,Cm,center] = manually_refine_components(Y,A_keep,C_keep,cm,Cn,tau,options);

%% update spatial components

[A1,b,Cin1] = update_spatial_components(data.Yr,C,f,[A,b],P,options);

%% isolate cells that are manually selected using ginput script
...
%% save the workspace except for the data memory mapped variable
