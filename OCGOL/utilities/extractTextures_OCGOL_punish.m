...
for ii=1:size(rewards_idx,2)
    ...
    rewards{ii}.lapNb = lap_nb(rewards_idx{ii});
end
...
%missed - QC code above checks for it

%0 = missed reward signal
%find lap where reward was missed
reward_lap_missed = find(lap_id.reward_based == 0);
