function [Events, Behavior] = resample_and_determine_run(Events,Behavior,Imaging, options)
...
%edges = time (simple turns of the edges of each bin
[N2,edges,bin2] = histcounts(Cdf_time,time);

%isequal(N,N2') - does not equal
...
%does the same regardless assign from changing the indexing
