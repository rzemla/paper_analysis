...
for ss=options.sessionSelect
    ...
    %assignmnet log 2- corr A; 3 - corr B; 20 - wrong A; 30 - wrong B
    ...
    sce_assign_log{ss}(Aall_idx{ss}) = 20;
    sce_assign_log{ss}(Ball_idx{ss}) = 30;
    
    sce_assign_log{ss}(Acorr_idx{ss}) = 2;
    sce_assign_log{ss}(Bcorr_idx{ss}) = 3;
