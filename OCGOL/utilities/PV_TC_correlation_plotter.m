...
%% PV and TC (ts) by animal line plots for figures for Figure 4F (old)
...
%% FINAL plot for Figure 4F (PV correlation raw and TC TS correlation raw - export this data)
...
PV_TC_plot_data.TC_mean_sem = TC_mean_sem;
PV_TC_plot_data.PV_mean_sem = PV_mean_sem;
...
%% Plot TC with raw results and cross correlated data (ST RECALL) - NOT THIS
% 
% %TC TS
