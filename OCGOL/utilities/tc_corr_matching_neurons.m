...
tc_corr_match.ts.TC_corr_all_day_nonsorted = TC_corr_all_day_nonsorted;
...
tc_corr_match.ts.TC_corr_counts = TC_corr_counts;

%export matching indices (already paired for each day)
tc_corr_match.ts.matching_ROI_all_day_idx = matching_ROI_all_day_idx.ts;
