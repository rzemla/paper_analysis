function [trialRanges] = discoverTrialType_punish(trialTypeCh ,position)

%% Texture signal discovery

%how many voltage bins; 20 = 0.25 V, 10 = 0.50 V
%voltageBins = 5;
%voltage edges for binning - avoid using bins since kmeans can split same
%trial signals into separate based on small differences (voltages)
voltageEdges = [0 2 4 5];
