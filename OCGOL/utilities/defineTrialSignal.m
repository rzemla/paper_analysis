function [trialType] = defineTrialSignal(trialRanges, trialTypeCh, Behavior)
...
%% Find time and position of each texture
 ...
 %% Enforce order of texture (low voltage B trials first near; high voltage A trials far - later)
