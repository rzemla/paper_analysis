...
placeField_global_centroid{2}{1} = placeField_final{1}(mid_field_idx);
placeField_global_centroid{2}{2} = placeField_final{2}(mid_field_idx);
...
%global remapping
event_pos_inField_global_centroid{2}{1} = event_pos_inField_final{1}(mid_field_idx);
event_pos_inField_global_centroid{2}{2} = event_pos_inField_final{2}(mid_field_idx);

event_pos_inField_global_centroid{3}{1} = event_pos_inField_final{1}(far_field_idx);
event_pos_inField_global_centroid{3}{2} = event_pos_inField_final{2}(far_field_idx);
...
%global remapping
events_in_field_global_centroid{2}{1} = events_in_field_final_filtered{1}(mid_field_idx);
events_in_field_global_centroid{2}{2} = events_in_field_final_filtered{2}(mid_field_idx);

events_in_field_global_centroid{3}{1} = events_in_field_final_filtered{1}(far_field_idx);
events_in_field_global_centroid{3}{2} = events_in_field_final_filtered{2}(far_field_idx);
...
rate_remap_pos_log = p_val < p_sig;
common_log = p_val >= p_sig;
...
global_overlap_near_log = ismember(partial_remap_idx_start,global_remap_ROI{2});
global_overlap_far_log = ismember(partial_remap_idx_start,global_remap_ROI{3});
...
remapping_ROIs.global_far = global_remap_ROI{3};
