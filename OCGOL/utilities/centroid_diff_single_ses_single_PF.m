function [cent_diff,cent_diff_AandB, pf_vector_max] = centroid_diff_single_ses_single_PF(session_vars,tunedLogical, pf_vector,field_event_rates,select_fields,options)
