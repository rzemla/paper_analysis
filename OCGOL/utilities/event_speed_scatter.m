...
%% Export to Prism for start analysis

%remove non-nans for prism analysis; get logical
A_sel_nonan = ~isnan(Asel_speed_diff);
B_sel_nonan = ~isnan(Bsel_speed_diff);

Asel_speed_diff_nonan = Asel_speed_diff(A_sel_nonan);
Bsel_speed_diff_nonan = Bsel_speed_diff(B_sel_nonan);
