function [outputArg1,outputArg2] = centroid_diff_learning(session_vars,tunedLogical, pf_vector,field_event_rates,registered,options)
...
[theta{1}] = centroid_angle_diff_btw_ROIs(uCar{1}{4},uCar{1}{5},pf_vector_max);
...
xlabel('Angular difference [rad]');
title('Random AB')
histogram(theta{2}(AandB_tuned{2}),15,'Normalization','probability','BinLimits',[0,pi]);
hold off
