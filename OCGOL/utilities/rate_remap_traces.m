...
for aa=1:11
    for rr=1:size(remap_traces_idx{aa}.remap_idx_traces,2)
        ...
        mean_dff_matrix.A(sp_idx,1:max_frame(sp_idx,1)) = mean(remap_traces_idx{aa}.remap_idx_traces{rr}.A,1);
        mean_dff_matrix.B(sp_idx,1:max_frame(sp_idx,2)) = mean(remap_traces_idx{aa}.remap_idx_traces{rr}.B,1);
