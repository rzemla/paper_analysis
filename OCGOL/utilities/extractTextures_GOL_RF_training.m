function [Behavior] = extractTextures_GOL_RF_training(CSV, Behavior,options)
...
%skip this part for RF of Figure 1
if 0
    ...
    %median reward location from previous day
    reward_loc = block1_d1_data.Behavior.performance.reward_loc;
end
...
%skip for long term learning - didn't registered reward loc early in trial
%channel, but did later for GOL RF
if 0
...
%skip for early RF assoociated with long term OCGOL learning
if 0
...
%Behavior.rewards = rewards;
 ...
 %skip for long term learning RF
 if 0
