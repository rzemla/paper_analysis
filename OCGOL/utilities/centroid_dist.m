function [outputArg1,outputArg2] = centroid_dist(tunedLogical, max_bin_rate,options)
...
%only A; only B
bin_rate.A = max_bin_rate{1}{1}(onlyA_tuned{1, 1});
bin_rate.B = max_bin_rate{1}{2}(onlyB_tuned{1, 1});
