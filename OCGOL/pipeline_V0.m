...
% %setDir = 'G:\GOL\I55_RTLS_RF_GOL_022219\6';
...
%split this into 2 functions - 1 to resample and one to determine run epochs
%check the run code again, but should be ok
...
for ii=1
    ...
    %and smooth function of matlab
    %lap breakdown happens here
    ...
    disp('3')
    %split TS and SI shuffle calculation - see if optimization possible
