...
[CNMF_learn,reg_learn,session_vars_learn] = figure4_load_data_rev(options);
toc;

%% Source data export struct - Fig 4 data

source_data_short_learn_recall = struct();
...
[perf_mean_sem_exp,perf_data_plotting] = cumulative_performance_plot(short_term_learn,short_term_recall,long_term_recall,excl_day_combined_day_nan);
...
[frac_tuned_across_days,si_frac_export,ts_frac_export] = plot_fraction_tuned_update(short_term_learn.tuned_frac, ...
                    short_term_recall.tuned_frac, long_term_recall.tuned_frac);

%export data for statistical analysis                
source_data_short_learn_recall.si_frac_export = si_frac_export;
source_data_short_learn_recall.ts_frac_export = ts_frac_export;
...
[PV_TC_plot_data,performance_mean_sem] = PV_TC_correlation_plotter(corr_analysis,perf_mean_sem_exp);
...
%export data for statistical analysis
source_data_short_learn_recall.PV = PV;
source_data_short_learn_recall.TC = TC;
...
%export data for statistical analysis
source_data_short_learn_recall.angle_diff = return_angle_diff;

%corr analysis contains A&B tuned lap correlation across time substructs
%(Fig 5)
...
%% Show outlines of neightboring day matching componenets (1 vs. 3) - learning - show overlapping outlines of ROIs vs. fills
