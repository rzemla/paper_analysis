...
%% Correlation of A&B tuned neurons across time - TC TS short term
...
[st_learn.AB_corr.ts.mean_TC,st_learn.AB_corr.ts.sem_TC,st_learn.AB_corr.ts.raw] =  filter_convert_day_return_AB_correlation_across_time(short_term_learn,excl_day_combined_day_nan,exp_type,day_range,tuning_type);
...
[st_learn.AB_corr.si.mean_TC,st_learn.AB_corr.si.sem_TC,st_learn.AB_corr.si.raw] =  filter_convert_day_return_AB_correlation_across_time(short_term_learn,excl_day_combined_day_nan,exp_type,day_range,tuning_type);
