...
[tuned_count, fracTuned_si, fracTuned_ts] = fractionTuned(tunedLogical);
...
PV_TC_correlation_single_ses(session_vars,tunedLogical,options)
...
centroid_dist(tunedLogical, max_bin_rate,options)
