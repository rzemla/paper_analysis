...
%I45 LT (1,1,1,1)
distList{1} = {'G:\Figure_1_OCGOL_learning_long_term\I45_RT\behavior_only\I45_RT_rand_d1_052218',...
...
%I46 (1,1,1,1)
distList{2} = {'G:\Figure_1_OCGOL_learning_long_term\I46\behavior_only\I46_rand_d1_052918',...
...
%I47 RS (1,0,1,1)
distList{3} = {'G:\Figure_1_OCGOL_learning_long_term\I47_RS\behavior_only\I47_RS_rand_d2_051518',...
...
%I47LP (1,1,1,1)
distList{4} = {'G:\Figure_1_OCGOL_learning_long_term\I47_LP\behavior_only\I47_LP_rand_d2_051518',...
...
for ii = 1:size(dirlist,2)
   stages{ii} = load(fullfile()[dirlist{ii} '\Behavior.mat'],'licks','Behavior');    
end
