function [outputArg1,outputArg2] = writeOneSampleWilcoxAnimal_1(actx_word_p,doc_handle,comp_descrip,test_stat,p_val, dof, sample_n)
%no multiple comparisons correction here
...
%write test name
actx_word_p.Selection.TypeText(': two-tailed 1-sample Wilcoxon signed-rank test against 1, ');
...
actx_word_p.Selection.Font.Italic = false;
actx_word_p.Selection.TypeText([' = ', num2str(sample_n),' neurons']);
