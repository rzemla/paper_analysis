function [outputArg1,outputArg2] = writePairedTtestAnimal_no_pcor(actx_word_p,doc_handle,comp_descrip,test_stat,p_val, dof, sample_n)
...
%write test name
actx_word_p.Selection.TypeText(': two-tailed paired ');
